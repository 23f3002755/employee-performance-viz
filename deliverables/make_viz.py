...
def generate_employee_df(n=100, seed=42):
    ...
    # Bias a bit towards Sales/Engineering so counts look realistic
...
def plot_department_histogram(df):
    ...
    ax.set_title("Department Distribution (n={})".format(len(df)))
...
def write_html(output_path, img_b64, sales_count):
    html = f"""<!doctype html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <div>Generated by Python + Seaborn; the figure below is embedded as base64.</div>
  <div class="figure">
...
def main():
    ...
    write_html(output_html, img_b64, sales_count)
